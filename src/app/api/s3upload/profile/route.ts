...
export const POST = async (req: NextRequest) => {
    ...
    const formArray = formData.getAll("files").filter((array) => array instanceof File)
        ...
        try {
                const paralleUploads3 = new Upload({
                    ...
                    params: { Bucket: "pakxiv", Key: `profile/${uniqueId}`, Body: file, ContentType: file.type },
    ...
    console.log("配列確認",uuidPro)
    return NextResponse.json(uuidPro)
}